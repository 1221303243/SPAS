...
<head>
    ...
    <title>SPAS - Student Registration</title>
...
<body>
    <div class="signup-container">
        <h2 class="signup-title">Student Registration</h2>
        ...
        <form id="signupForm" method="post" action="signup_handler.php" autocomplete="off">
            ...
            <div class="mb-3">
                ...
                <div class="form-text" id="emailHint" style="display: none;">
                    <i class="bi bi-info-circle"></i> Students must use a Malaysian educational institution email (.edu.my)
                </div>
            </div>
            <div class="mb-3">
    ...
    <script>
    // Show email hint for students (always visible now)
